...
export default function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-rose-100/70 bg-cream/85 backdrop-blur-md">
      <nav className="mx-auto flex max-w-6xl items-center justify-between px-5 py-3.5">
        ...
        <div className="hidden items-center gap-8 md:flex">
          ...
          {user ? (
            ...
            <Link
              to="/login"
              className="rounded-full bg-ink px-5 py-2 text-sm text-cream transition-transform hover:scale-[1.03]"
            >
              OneID bilan kirish
            </Link>
          )}
          ...
          <div className="flex flex-col gap-4">
            ...
            {user ? (
              ...
              <Link
                to="/login"
                onClick={() => setOpen(false)}
                className="rounded-full bg-ink px-5 py-2.5 text-center text-base text-cream"
              >
                OneID bilan kirish
              </Link>
            )}
